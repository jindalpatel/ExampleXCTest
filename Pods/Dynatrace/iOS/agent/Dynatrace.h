 ...
 */
+ (DTX_StatusCode)enableCrashReportingWithReport:(BOOL)sendCrashReport
                             hockeyAppIdentifier:(NSString* _Nonnull)appIdentifier
                        hockeyWaitUntilReachable:(BOOL)waitUntilReachable
                                    hockeyUserId:(NSString* _Nullable)userId
                                  hockeyUserName:(NSString* _Nullable)userName
                              hockeyContactEmail:(NSString* _Nullable)contactEmail
                          hockeyCrashDescription:(NSString* _Nullable)description;
...
+ (DTX_StatusCode)enableCrashReportingWithReport:(BOOL)sendCrashReport
                                 emailRecipients:(NSArray* _Nullable)recipients
                                    emailSubject:(NSString* _Nullable)subject
                                    emailMessage:(NSString* _Nullable)message
                                   emailFilename:(NSString* _Nullable)filename
                            sendAppleStyleReport:(BOOL)sendAppleStyleReport
                                      alertTitle:(NSString* _Nullable)alertTitle
                                    alertMessage:(NSString* _Nullable)alertMessage
                                   yesButtonText:(NSString* _Nullable)yesButtonText
                                    noButtonText:(NSString* _Nullable)noButtonText;
